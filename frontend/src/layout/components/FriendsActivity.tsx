...
const FriendsActivity = () => {
  ...
  return (
    <div className="h-full bg-zinc-900 rounded flex flex-col">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="relative">
                                ...
                                <div className={`absolute bottom-0 right-0 h-3 w-3 rounded-full border-2 border-zinc-900 
                                    ${onlineUsers.has(user.clerkId) ? "bg-green-500" : "bg-zinc-500" }`} arial-hidden="true" />
                            </div>
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                {isPlaying ? (
                                    <div className="mt-1">
                                        <div className="mt-1 text-white font-medium truncate">{activity.replace("playing ", "").split(" by ")[0]}</div>
